	...
	return (
		<div className="min-h-screen flex justify-center items-center">
			<motion.div
				...
				className='max-w-md w-full border-[1px] border-gray-200 bg-white bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'
			>
				<div className='p-8'>
				...
				<div className='px-8 py-4 bg-gray-400/20 flex justify-center'>
